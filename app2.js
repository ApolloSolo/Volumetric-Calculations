...
const frac2ATotalOutput = document.querySelector('#twoA-total-gal');
const frac2AWaterOutput = document.querySelector('#twoA-water-gal');
const fra2AProductOutput = document.querySelector('#twoA-product-gal');
...
const frac2BTotalOutput = document.querySelector('#twoB-total-gal');
const frac2BWaterOutput = document.querySelector('#twoB-water-gal');
const fra2BProductOutput = document.querySelector('#twoB-product-gal');
