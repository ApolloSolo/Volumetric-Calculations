...
const frac3ATotalOutput = document.querySelector('#threeA-total-gal');
const frac3AWaterOutput = document.querySelector('#threeA-water-gal');
const fra3AProductOutput = document.querySelector('#threeA-product-gal');
...
const frac3BTotalOutput = document.querySelector('#threeB-total-gal');
const frac3BWaterOutput = document.querySelector('#threeB-water-gal');
const fra3BProductOutput = document.querySelector('#threeB-product-gal');
